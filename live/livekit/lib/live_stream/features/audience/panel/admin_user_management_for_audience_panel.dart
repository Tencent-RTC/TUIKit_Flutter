...
import '../../anchor_broadcast/common/anchor_user_management_panel_base.dart';


class AdminUserManagementForAudiencePanel extends StatefulWidget {
  final LiveUserInfo user;
  final LiveStreamManager liveStreamManager;
  final VoidCallback closeCallback;

  const AdminUserManagementForAudiencePanel({
    super.key,
    required this.user,
  ...
  @override
  State<AdminUserManagementForAudiencePanel> createState() => _AdminUserManagementForAudiencePanelState();
}

class _AdminUserManagementForAudiencePanelState extends State<AdminUserManagementForAudiencePanel> {
...
extension on _AdminUserManagementForAudiencePanelState {
