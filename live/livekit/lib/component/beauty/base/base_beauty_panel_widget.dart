...
class BaseBeautyPanelWidget extends StatefulWidget {
  const BaseBeautyPanelWidget({super.key});

  @override
  State<BaseBeautyPanelWidget> createState() => _BaseBeautyPanelWidgetState();
}

class _BaseBeautyPanelWidgetState extends State<BaseBeautyPanelWidget> {
...
extension on _BaseBeautyPanelWidgetState {
