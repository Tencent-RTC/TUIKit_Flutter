...
class AtomicLocalizationsAr extends AtomicLocalizations {
  ...
  String get permissionDeniedContent =>
      'يرجى الذهاب إلى الإعدادات وتفعيل الأذونات المطلوبة.';

  @override
  String get permissionDeniedCamera =>
      'يرجى الذهاب إلى الإعدادات وتفعيل أذونات الكاميرا.';

  @override
  String get permissionDeniedMicrophone =>
      'يرجى الذهاب إلى الإعدادات وتفعيل أذونات الميكروفون.';
  ...
  String get permissionDeniedStorage =>
      'يرجى الذهاب إلى الإعدادات وتفعيل أذونات التخزين.';

  @override
  String get permissionDeniedNotification =>
      'يرجى الذهاب إلى الإعدادات وتفعيل أذونات الإشعارات.';
