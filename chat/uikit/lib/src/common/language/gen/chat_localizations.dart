...
abstract class ChatLocalizations {
  ...
  /// No description provided for @dateMonthDayFormat.
  ///
  /// In en, this message translates to:
  /// **'{month}/{day}'**
  String dateMonthDayFormat(int month, int day);

  /// No description provided for @dateYearMonthDayFormat.
  ///
  /// In en, this message translates to:
  /// **'{month}/{day}/{year}'**
  ...
  /// No description provided for @selectChatBackground.
  ///
  /// In en, this message translates to:
  /// **'Select Chat Background'**
  String get selectChatBackground;
  ...
  /// No description provided for @chatBackgroundCustom.
  ///
  /// In en, this message translates to:
  /// **'Custom'**
  ...
  /// No description provided for @postEmojis.
  ///
  /// In en, this message translates to:
  /// **'React'**
  String get postEmojis;
  ...
  /// No description provided for @deleteConversationTip.
  ///
  /// In en, this message translates to:
  ...
  /// Label on a reaction chip when several users reacted with the same emoji. Locales phrase this either around the total ('{name} 等 {totalCount} 人') or around the remainder ('{name} and {othersCount} others'), so both counts are supplied and each translation uses whichever one it needs.
  ///
  /// In en, this message translates to:
  /// **'{name} and {othersCount} others'**
