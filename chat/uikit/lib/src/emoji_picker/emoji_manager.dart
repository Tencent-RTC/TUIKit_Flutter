...
class EmojiManager {
  static Map<String, String> getEmojiMap(BuildContext context) {
    ...
    return {
      '[TUIEmoji_Smile]': chatLocale.tuiEmojiSmile,
      '[TUIEmoji_Expect]': chatLocale.tuiEmojiExpect,
      '[TUIEmoji_Blink]': chatLocale.tuiEmojiBlink,
      '[TUIEmoji_Guffaw]': chatLocale.tuiEmojiGuffaw,
      '[TUIEmoji_KindSmile]': chatLocale.tuiEmojiKindSmile,
      '[TUIEmoji_Haha]': chatLocale.tuiEmojiHaha,
      '[TUIEmoji_Cheerful]': chatLocale.tuiEmojiCheerful,
      '[TUIEmoji_Speechless]': chatLocale.tuiEmojiSpeechless,
      '[TUIEmoji_Amazed]': chatLocale.tuiEmojiAmazed,
      '[TUIEmoji_Sorrow]': chatLocale.tuiEmojiSorrow,
      '[TUIEmoji_Complacent]': chatLocale.tuiEmojiComplacent,
      '[TUIEmoji_Silly]': chatLocale.tuiEmojiSilly,
      '[TUIEmoji_Lustful]': chatLocale.tuiEmojiLustful,
      '[TUIEmoji_Giggle]': chatLocale.tuiEmojiGiggle,
      '[TUIEmoji_Kiss]': chatLocale.tuiEmojiKiss,
      '[TUIEmoji_Wail]': chatLocale.tuiEmojiWail,
      '[TUIEmoji_TearsLaugh]': chatLocale.tuiEmojiTearsLaugh,
      '[TUIEmoji_Trapped]': chatLocale.tuiEmojiTrapped,
      '[TUIEmoji_Mask]': chatLocale.tuiEmojiMask,
      '[TUIEmoji_Fear]': chatLocale.tuiEmojiFear,
      '[TUIEmoji_BareTeeth]': chatLocale.tuiEmojiBareTeeth,
      '[TUIEmoji_FlareUp]': chatLocale.tuiEmojiFlareUp,
      '[TUIEmoji_Yawn]': chatLocale.tuiEmojiYawn,
      '[TUIEmoji_Tact]': chatLocale.tuiEmojiTact,
      '[TUIEmoji_Stareyes]': chatLocale.tuiEmojiStareyes,
      '[TUIEmoji_ShutUp]': chatLocale.tuiEmojiShutUp,
      '[TUIEmoji_Sigh]': chatLocale.tuiEmojiSigh,
      '[TUIEmoji_Hehe]': chatLocale.tuiEmojiHehe,
      '[TUIEmoji_Silent]': chatLocale.tuiEmojiSilent,
      '[TUIEmoji_Surprised]': chatLocale.tuiEmojiSurprised,
      '[TUIEmoji_Askance]': chatLocale.tuiEmojiAskance,
      '[TUIEmoji_Ok]': chatLocale.tuiEmojiOk,
      '[TUIEmoji_Shit]': chatLocale.tuiEmojiShit,
      '[TUIEmoji_Monster]': chatLocale.tuiEmojiMonster,
      '[TUIEmoji_Daemon]': chatLocale.tuiEmojiDaemon,
      '[TUIEmoji_Rage]': chatLocale.tuiEmojiRage,
      '[TUIEmoji_Fool]': chatLocale.tuiEmojiFool,
      '[TUIEmoji_Pig]': chatLocale.tuiEmojiPig,
      '[TUIEmoji_Cow]': chatLocale.tuiEmojiCow,
      '[TUIEmoji_Ai]': chatLocale.tuiEmojiAi,
      '[TUIEmoji_Skull]': chatLocale.tuiEmojiSkull,
      '[TUIEmoji_Bombs]': chatLocale.tuiEmojiBombs,
      '[TUIEmoji_Coffee]': chatLocale.tuiEmojiCoffee,
      '[TUIEmoji_Cake]': chatLocale.tuiEmojiCake,
      '[TUIEmoji_Beer]': chatLocale.tuiEmojiBeer,
      '[TUIEmoji_Flower]': chatLocale.tuiEmojiFlower,
      '[TUIEmoji_Watermelon]': chatLocale.tuiEmojiWatermelon,
      '[TUIEmoji_Rich]': chatLocale.tuiEmojiRich,
      '[TUIEmoji_Heart]': chatLocale.tuiEmojiHeart,
      '[TUIEmoji_Moon]': chatLocale.tuiEmojiMoon,
      '[TUIEmoji_Sun]': chatLocale.tuiEmojiSun,
      '[TUIEmoji_Star]': chatLocale.tuiEmojiStar,
      '[TUIEmoji_RedPacket]': chatLocale.tuiEmojiRedPacket,
      '[TUIEmoji_Celebrate]': chatLocale.tuiEmojiCelebrate,
      '[TUIEmoji_Bless]': chatLocale.tuiEmojiBless,
      '[TUIEmoji_Fortune]': chatLocale.tuiEmojiFortune,
      '[TUIEmoji_Convinced]': chatLocale.tuiEmojiConvinced,
      '[TUIEmoji_Prohibit]': chatLocale.tuiEmojiProhibit,
      '[TUIEmoji_666]': chatLocale.tuiEmoji666,
      '[TUIEmoji_857]': chatLocale.tuiEmoji857,
      '[TUIEmoji_Knife]': chatLocale.tuiEmojiKnife,
      '[TUIEmoji_Like]': chatLocale.tuiEmojiLike,
    };
  }
